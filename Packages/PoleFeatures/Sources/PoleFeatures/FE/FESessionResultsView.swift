...
@MainActor
@Observable
public final class FESessionResultsViewModel {
    enum State {
        case idle
        case loading
    ...
    public init(ref: FESessionRef) { self.ref = ref }
...
public struct FESessionResultsView: View {
    @State private var viewModel: FESessionResultsViewModel

    public init(ref: FESessionRef) {
